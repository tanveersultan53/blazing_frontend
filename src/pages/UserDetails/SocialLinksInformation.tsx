...
const SocialLinksInformation = () => {
  ...
  const initialValues = {
    ...
    moneyapplabel: data?.data?.moneyapplabel || "",
      ...
      <Card className="mb-12">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <div>
            ...
            <CardDescription>
              You can also update social links information here by clicking the
              update button.{" "}
            </CardDescription>
          </div>
          {!isEditMode && (
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  {errors.blogr && (
                    <p className="text-sm text-red-500">
                      {errors.blogr.message as string}
                    </p>
                  )}
                </div>
                <div className="space-y-2">
                  ...
                  {errors.google && (
                    <p className="text-sm text-red-500">
                      {errors.google.message as string}
                    </p>
                  )}
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  {errors.vimeo && (
                    <p className="text-sm text-red-500">
                      {errors.vimeo.message as string}
                    </p>
                  )}
                </div>
                <div className="space-y-2">
                  <label
                    htmlFor="moneyapplabel"
                    className="text-xs font-medium text-muted-foreground"
                  >
                    Moneyapp label
                  </label>
                  <Input
                    id="moneyapplabel"
                    type="text"
                    placeholder="Enter moneyapp label"
                ...
                <div className="space-y-2">
                  ...
                  {errors.moneyapp && (
                    <p className="text-sm text-red-500">
                      {errors.moneyapp.message as string}
                    </p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {errors.socialapp && (
                    <p className="text-sm text-red-500">
                      {errors.socialapp.message as string}
                    </p>
                  )}
                </div>
              </div>
