...
const AddPersonForm = ({ type }: { type: string | null }) => {
  ...
  const showLoanFields =
    currentUser?.industry_type === "Mortgage" && type === "contact";
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) => setValue("send_status", value)}
                value={watch("send_status")}
              >
                <SelectTrigger
                  className={`w-full ${errors.send_status ? "border-red-500" : ""}`}
                >
            ...
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) => setValue("optout", value)}
                value={watch("optout")}
              >
                <SelectTrigger
                  className={`w-full ${errors.optout ? "border-red-500" : ""}`}
                >
            ...
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) =>
                  setValue(
                    "newsletter_version",
                    value as "long" | "short" | "none",
                  )
                }
                value={watch("newsletter_version")}
              >
                <SelectTrigger
                  className={`w-full ${errors.newsletter_version ? "border-red-500" : ""}`}
                >
              ...
              {errors.newsletter_version && (
                <p className="text-sm text-red-500">
                  {errors.newsletter_version.message}
                </p>
              )}
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={
                    errors.secondary_first_name ? "border-red-500" : ""
                  }
                />
              ...
              <div className="space-y-2">
                ...
                <div className="w-full">
                  <DatePicker
                    value={
                      watch("secondary_birthday")
                        ? new Date(watch("secondary_birthday")!)
                        : undefined
                    }
                ...
                {errors.secondary_birthday && (
                  <p className="text-sm text-red-500">
                    {errors.secondary_birthday.message}
                  </p>
                )}
              </div>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  onValueChange={(value) => setValue("loan_status", value)}
                  value={watch("loan_status")}
                >
                  <SelectTrigger
                    className={`w-full ${errors.loan_status ? "border-red-500" : ""}`}
                  >
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger
                    className={`w-full ${errors.loan_type ? "border-red-500" : ""}`}
                  >
