...
const LoginPage: React.FC = () => {
  ...
  const loginUserMutation = useMutation({
    ...
    onSuccess: ({ data }: { data: { access_token: string, refresh_token: string } }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#c33b00] to-[#a02d00] flex items-center justify-center p-4 relative overflow-hidden">
      {/* Background decorative elements */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#c33b00] to-[#a02d00] opacity-95"></div>
      <div className="w-full max-w-md relative z-10">
        <Card className="shadow-2xl border-0 bg-white backdrop-blur-md ring-1 ring-white/20">
