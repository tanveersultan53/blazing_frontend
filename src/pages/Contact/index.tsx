...
import { ArrowLeft, Calendar, User, Users, FileText, Save, X, Mail, Gift } from "lucide-react";
...
const Contact = () => {
    ...
    return (
        <div className="container mx-auto p-6 space-y-6">
            ...
            {/* All Contact Information in One Card */}
            <Card>
                <CardHeader>
                ...
                <CardContent>
                    ...
                    {/* Secondary Contact Information - Only show for contacts, not partners */}
                    {contact.customer_type !== 'partner' && (contact.secondary_first_name || contact.secondary_email) && (
                        <>
                            <Separator className="my-6" />
                            <div className="space-y-4">
                                <h4 className="font-medium text-sm text-gray-700 border-b pb-2 flex items-center">
                    ...
                    {/* Loan Information - Only show for contacts, not partners */}
                    ...
                    {/* System Information - At the very end */}
                    <Separator className="my-6" />
